...
/**
 * Task streaks table for tracking consecutive days of completed tasks
 */
export const taskStreaks = mysqlTable("taskStreaks", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
...
export type InsertTaskStreak = typeof taskStreaks.$inferInsert;